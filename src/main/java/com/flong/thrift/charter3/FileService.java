...
public class FileService {
	...
	public interface Iface {
		...
		public boolean uploadFile(FileEntity entity) throws org.apache.thrift.TException;

	}

	public interface AsyncIface {

		public void uploadFile(FileEntity entity, org.apache.thrift.async.AsyncMethodCallback resultHandler)
	...
	public static class Client extends org.apache.thrift.TServiceClient implements Iface {
		...
		public boolean uploadFile(FileEntity entity) throws org.apache.thrift.TException {
			send_uploadFile(entity);
			return recv_uploadFile();
		}

		public void send_uploadFile(FileEntity entity) throws org.apache.thrift.TException {
		...
		public boolean recv_uploadFile() throws org.apache.thrift.TException {
			...
			throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT,
					"uploadFile failed: unknown result");
		}
	...
	public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
		...
		public void uploadFile(FileEntity entity, org.apache.thrift.async.AsyncMethodCallback resultHandler)
				throws org.apache.thrift.TException {
			checkReady();
			uploadFile_call method_call = new uploadFile_call(entity, resultHandler, this, ___protocolFactory,
					___transport);
		...
		public static class uploadFile_call extends org.apache.thrift.async.TAsyncMethodCall {
			...
			public uploadFile_call(FileEntity entity, org.apache.thrift.async.AsyncMethodCallback resultHandler,
			...
			public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
				prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("uploadFile",
	...
	public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I>
		...
		public static class uploadFile<I extends Iface> extends org.apache.thrift.ProcessFunction<I, uploadFile_args> {
			...
			public uploadFile_result getResult(I iface, uploadFile_args args) throws org.apache.thrift.TException {
				uploadFile_result result = new uploadFile_result();
				result.success = iface.uploadFile(args.entity);
	...
	public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
		...
		public static class uploadFile<I extends AsyncIface>
				extends org.apache.thrift.AsyncProcessFunction<I, uploadFile_args, Boolean> {
			public uploadFile() {
				super("uploadFile");
			}
			...
			public void start(I iface, uploadFile_args args,
					org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws TException {
				iface.uploadFile(args.entity, resultHandler);
			}
		}

	}

	public static class uploadFile_args implements org.apache.thrift.TBase<uploadFile_args, uploadFile_args._Fields>,
			java.io.Serializable, Cloneable, Comparable<uploadFile_args> {
		...
		public FileEntity entity; // required
		...
		public uploadFile_args(FileEntity entity) {
			this();
			this.entity = entity;
		}
		...
		public uploadFile_args(uploadFile_args other) {
			if (other.isSetEntity()) {
				this.entity = new FileEntity(other.entity);
			}
		}
		...
		public uploadFile_args setEntity(FileEntity entity) {
			this.entity = entity;
			return this;
		}
		...
		/**
		 * Returns true if field entity is set (has been assigned a value) and false
		 * otherwise
		 */
		...
		private static class uploadFile_argsStandardScheme extends StandardScheme<uploadFile_args> {
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot, uploadFile_args struct)
					throws org.apache.thrift.TException {
			...
			public void write(org.apache.thrift.protocol.TProtocol oprot, uploadFile_args struct)
					throws org.apache.thrift.TException {
				struct.validate();
		...
		private static class uploadFile_argsTupleScheme extends TupleScheme<uploadFile_args> {
			...
			@Override
			public void write(org.apache.thrift.protocol.TProtocol prot, uploadFile_args struct)
					throws org.apache.thrift.TException {
			...
			@Override
			public void read(org.apache.thrift.protocol.TProtocol prot, uploadFile_args struct)
					throws org.apache.thrift.TException {
	...
	public static class uploadFile_result
			implements org.apache.thrift.TBase<uploadFile_result, uploadFile_result._Fields>, java.io.Serializable,
			Cloneable, Comparable<uploadFile_result> {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"uploadFile_result");
		...
		public uploadFile_result(boolean success) {
			this();
		...
		private static class uploadFile_resultStandardScheme extends StandardScheme<uploadFile_result> {
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot, uploadFile_result struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
			...
			public void write(org.apache.thrift.protocol.TProtocol oprot, uploadFile_result struct)
					throws org.apache.thrift.TException {
				struct.validate();
		...
		private static class uploadFile_resultTupleScheme extends TupleScheme<uploadFile_result> {
			...
			@Override
			public void write(org.apache.thrift.protocol.TProtocol prot, uploadFile_result struct)
					throws org.apache.thrift.TException {
				TTupleProtocol oprot = (TTupleProtocol) prot;
				BitSet optionals = new BitSet();
				if (struct.isSetSuccess()) {
			...
			@Override
			public void read(org.apache.thrift.protocol.TProtocol prot, uploadFile_result struct)
					throws org.apache.thrift.TException {
				TTupleProtocol iprot = (TTupleProtocol) prot;
				BitSet incoming = iprot.readBitSet(1);
				if (incoming.get(0)) {
