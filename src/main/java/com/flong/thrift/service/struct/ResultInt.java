...
public class ResultInt implements org.apache.thrift.TBase<ResultInt, ResultInt._Fields>, java.io.Serializable, Cloneable, Comparable<ResultInt> {
  ...
  static {
    schemes.put(StandardScheme.class, new ResultIntStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ResultIntTupleSchemeFactory());
  }
  ...
  private static class ResultIntStandardSchemeFactory implements SchemeFactory {
    public ResultIntStandardScheme getScheme() {
      return new ResultIntStandardScheme();
    }
  }

  private static class ResultIntStandardScheme extends StandardScheme<ResultInt> {
  ...
  private static class ResultIntTupleSchemeFactory implements SchemeFactory {
    public ResultIntTupleScheme getScheme() {
      return new ResultIntTupleScheme();
    }
  }

  private static class ResultIntTupleScheme extends TupleScheme<ResultInt> {
